...
<body>
     ...
     <img class = "main_title" src="image/titrepage.png">
        ...
        <a style="text-decoration:none" href="contactus.php" class="contact-page">Contact</a>
         ...
         <a class="retour" href="description-murderpro.php"> <p> < </p></a>
            <div class="title"><p><strong>Murder </strong></p></div>


        <div>
              <video title="Wildlife" controls width="1000" class="positionvideo" >
                <source src="image/teaser/how-to-get-away-with-murder-saison-1-recap-vostfr-murder-hd.mp4" type="video/mp4">
              <p>Wildlife</p>
              </video>
        </div>
</body>
