...
<html lang="en" dir="ltr">
        ...
        <title>Description - Harry Potter and the Philosopher's Stone</title>
...
<body>
     ...
     <img class = "main_title" src="image/titrepage.png">
        ...
        <a style="text-decoration:none" href="contactus.php" class="contact-page">Contact</a>
         ...
         <a class="retour" href="pagefilm_pro.php"> <p> < </p></a>
...
<div class = "position">
       ...
       <a class ="button_watch" href="teaser-harrypro.php">Watch Movie</a>
        ...
        <div >
          <img class = "affiche" src =image/harrypotter.jpg>
        </div>
