...
<html lang="en" dir="ltr">
        ...
        <title>Description - Murder</title>
...
<body>
     ...
     <img class = "main_title" src="image/titrepage.png">
        ...
        <a class ="button" href="deconnexion.php">Sign Out</a>
         ...
         <a class="retour" href="description-murder.php"> <p> < </p></a>
            <div class="title"><p><strong>Murder</strong></p></div>
...
<div class = "position">
       ...
       <a class ="button_watch" href="teaser-murder.php">Watch Movie</a>
        ...
        <div >
          <img class = "affiche" src =image/292581.jpg>
        </div>
