...
<html lang="en" dir="ltr">
        ...
        <title>Description - Vampire Diairies</title>
...
<body>
     ...
     <img class = "main_title" src="image/titrepage.png">
        ...
        <a style="text-decoration:none" href="contactus.php" class="contact-page">Contact</a>
         ...
         <a class="retour" href="pageserie.php"> <p> < </p></a>
            <div class="title"><p><strong>The Vampire Diaries</strong></p></div>
...
<div class = "position">
       ...
       <a class ="button_watch" href="teaser-vampire.php">Watch Movie</a>
        ...
        <div >
          <img class = "affiche" src =image/vignette-portrait-5c2b2f-ae1348-0@1x.webp>
        </div>
